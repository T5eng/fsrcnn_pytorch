...
# parser.add_argument('--input', type=str, required=False, default='./dataset/BSDS300/images/test/223061.jpg', help='input image to use')
parser.add_argument('--input', type=str, required=False, default='./dataset/BSDS300/images/general100+91images/tt13.bmp', help='input image to use')
